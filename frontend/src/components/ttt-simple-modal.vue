                        ...
                        >
                            <div>
                                <div
                                    ...
                                    :class="[{ 'bg-red-100': props.type === 'danger', 'bg-green-100': props.type === 'success' }]"
                                >
                                    <CheckIcon
                            ...
                            <div class="mt-5 sm:mt-6">
                                <button
                                    ...
                                    :class="[{ 'bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500': props.type === 'success', 'bg-red-600 hover:bg-red-700 focus:ring-red-500': props.type === 'danger' }]"
                                    @click="closeModal"
                                >
                                    <slot name="button" />
                                </button>
